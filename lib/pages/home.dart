...
class JoinScreen extends StatelessWidget {
  ...
  final TextEditingController game_key_controller = TextEditingController();
    ...
    return Center(
      child: Column(
        children: [
          ...
          TextField(
            controller: game_key_controller,
            decoration: const InputDecoration(
          ...
          Row(
            children: [
              ElevatedButton(onPressed: () async {
                final String gameKey = game_key_controller.text.trim();
                final String name = name_controller.text.trim();
              ...
              ElevatedButton(onPressed: () async {
                final String gameKey = game_key_controller.text.trim();
                Player player = Player(gameKey, name_controller.text.trim(), true);
